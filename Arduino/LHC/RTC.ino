...
time_t getTime(){
  ...
  return(RTCToUNIXTime(year, month, day, hour, minute, second));
}

void setNewTime(byte newHour,byte newMinute,byte newSecond,byte newDay,byte newMonth,byte newYear){
